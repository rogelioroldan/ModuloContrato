page 50249 "AvailableContratoPlanningLines"
{
    Caption = 'Available - Contrato Planning Lines';
    ...
    ModifyAllowed = false;
    PageType = List;
    Permissions = TableData "Contrato Planning Line" = rm;
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Location Code"; Rec."Location Code")
                {
                    ...
                    ToolTip = 'Specifies the location code for the item on the Contrato planning line.';
                }
            ...
            group("F&unctions")
            {
                ...
                action(ShowDocument)
                {
                    ...
                    begin
                        ...
                        PAGE.Run(PAGE::"Contrato Card", Contrato);
                    end;
                }
            }
        }
    ...
    begin
        ...
        TrackingSpecification.InitTrackingSpecification(
          DATABASE::"Contrato Planning Line", Rec.Status.AsInteger(), Rec."Contrato No.", '', 0, Rec."Contrato Contract Entry No.",
    ...
    local procedure OnAfterSetFilters(var ContratoPlanningLine: Record "Contrato Planning Line"; ReservationEntry: Record "Reservation Entry")
    begin
    end;
