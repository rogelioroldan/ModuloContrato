page 50233 "Contrato Archive Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(JobTaskLines; ContrTaskArchiveLinesSubform)
            {
                ApplicationArea = Jobs;
                Caption = 'Tasks';
    ...
    actions
    {
            ...
            group("&Contrato")
            {
                ...
                action(JobPlanningLines)
                {
                    ...
                    begin
                        ...
                        JobPlanningLineArchive.SetRange("Contrato No.", Rec."No.");
        ...
        area(processing)
        {
            action(Restore)
            {
                ...
                trigger OnAction()
                var
                    JobArchiveManagement: Codeunit "Contrato Archive Management";
                begin
