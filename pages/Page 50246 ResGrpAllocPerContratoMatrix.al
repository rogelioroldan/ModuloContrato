page 50246 "ResGrp.Alloc.perContratoMatrix"
{
    Caption = 'Res. Gr. Allocated per Contrato Matrix';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = List;
    ...
    var
        ...
        MatrixRec: Record "Contrato Planning Line";
    ...
    procedure Load(var NewVerticalRec: Record Contrato; var NewHorizontalRec: Record "Contrato Planning Line"; NewMatrixColumnCaptions: array[32] of Text[100]; var NewMatrixDateFilters: array[32] of Record Date)
    begin
    ...
    begin
        ...
        MatrixRec.SetRange("Contrato No.", Rec."No.");
    ...
    var
        ...
        IsHandled: Boolean;
    begin
        ContratoPlanningLine.SetFilter("Resource Group No.", Rec.GetRangeMin("Resource Gr. Filter"), Rec.GetRangeMax("Resource Gr. Filter"));
