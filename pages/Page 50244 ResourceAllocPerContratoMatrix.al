page 50244 "ResourceAllocperContratoMatrix"
{
    Caption = 'Resource Allocated per Contrato Matrix';
    ...
    procedure LoadMatrix(var NewVerticalRec: Record Contrato; var NewHorizontalRec: Record "Contrato Planning Line"; NewMatrixColumnCaptions: array[32] of Text[100]; var NewMatrixDateFilters: array[32] of Record Date; AmountType2: Enum "Analysis Amount Type")
    begin
