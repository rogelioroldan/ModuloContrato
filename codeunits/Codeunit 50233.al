codeunit 50233 "Sales-Post (Yes/No) Contrato"
{
    ...
    var
        ...
        SalesPostViaContratoQueue: Codeunit "Sales Post via Contrato Queue";
        HideDialog: Boolean;
        IsHandled: Boolean;
    ...
    begin
        ...
        if SalesSetup."Post with Job Queue" and not PostAndSend then
            SalesPostViaContratoQueue.EnqueueSalesDoc(SalesHeader)
        else
    ...
    var
        SalesPostYesNo: Codeunit "Sales-Post (Yes/No) Contrato";
