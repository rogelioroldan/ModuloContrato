codeunit 50236 "Sales-Post Contrato"
{
...
#pragma warning restore AA0470
        ...
        ContratoTaskSalesLine: Record "Sales Line";
        ...
        CodeSalesPostInvoiceContrato: Codeunit "Sales Post Invoice Contrato";
...
#pragma warning restore AA0470
    ...
    begin
        ...
        case SalesLine.Type of
            ...
            SalesLine.Type::Resource:
                PostResJnlLine(SalesHeader, SalesLine, ContratoTaskSalesLine);
    ...
    begin
        ...
        ShouldPostItemJnlLine := not ContratoContractLine;
    ...
    begin
        ...
        if (SalesLine.Type = SalesLine.Type::Item) or (SalesLine.Type = SalesLine.Type::"G/L Account") or (SalesLine.Type = SalesLine.Type::" ") then
            if SalesLine."Job Contract Entry No." > 0 then
                PostContratoContractLine(SalesHeader, SalesLine);
        OnUpdateSalesLineBeforePostOnAfterPostContratoContractLine(SalesInvHeader, SalesCrMemoHeader, SalesHeader, SalesLine);
        if SalesLine.Type = SalesLine.Type::Resource then
            ContratoTaskSalesLine := SalesLine;
...
#pragma warning restore AA0005
    ...
    local procedure PostContratoContractLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line")
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforePostContratoContractLine(
            SalesHeader, SalesLine, IsHandled, ContratoContractLine, InvoicePostingInterface, SalesLineACY, SalesInvHeader, SalesCrMemoHeader);
        if IsHandled then
            exit;
        ...
        IsHandled := false;
        OnPostContratoContractLineBeforeTestFields(SalesHeader, SalesLine, IsHandled);
        if not IsHandled then begin
        ...
        ContratoContractLine := true;
#if not CLEAN23
        if UseLegacyInvoicePosting() then
            ContratoPostLine.PostInvoiceContractLine(SalesHeader, SalesLine)
        else
#endif
        CodeSalesPostInvoiceContrato.PrepareContratoLine(SalesHeader, SalesLine, SalesLineACY);
    end;
    ...
    begin
        ...
        if TempInvoicePostBuffer.Find('+') then
            repeat
                ...
                then
                    //ContratoPostLine.PostSalesGLAccounts(TempInvoicePostBuffer, GLEntryNo);
    ...
    begin
        ...
        if Contrato.Get(SalesLine."Job No.") then
    ...
    var
        FeatureKeyManagement: Codeunit "Feature Key Management Cont";
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostContratoContractLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; var IsHandled: Boolean; var ContratoContractLine: Boolean; var InvoicePostingInterface: Interface "Invoice Posting"; SalesLineACY: Record "Sales Line"; SalesInvHeader: Record "Sales Invoice Header"; SalesCrMemoHeader: Record "Sales Cr.Memo Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterPostResJnlLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; ContratoTaskSalesLine: Record "Sales Line"; ResJnlLine: Record "Res. Journal Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostResJnlLine(var SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var ContratoTaskSalesLine: Record "Sales Line"; var IsHandled: Boolean; DocNo: Code[20]; ExtDocNo: Code[35]; SourceCode: Code[10]; SalesShptHeader: Record "Sales Shipment Header"; ReturnRcptHeader: Record "Return Receipt Header"; var ResJnlPostLine: Codeunit "Res. Jnl.-Post Line")
    begin
    end;
    ...
    local procedure PostResJnlLine(var SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var ContratoTaskSalesLine: Record "Sales Line")
    var
    ...
    begin
        IsHandled := false;
        OnBeforePostResJnlLine(SalesHeader, SalesLine, ContratoTaskSalesLine, IsHandled, GenJnlLineDocNo, GenJnlLineExtDocNo, SrcCode, SalesShptHeader, ReturnRcptHeader, ResJnlPostLine);
        if IsHandled then
            exit;
        ...
        if ContratoTaskSalesLine."Job Contract Entry No." > 0 then
            PostContratoContractLine(SalesHeader, ContratoTaskSalesLine);

        OnAfterPostResJnlLine(SalesHeader, SalesLine, ContratoTaskSalesLine, ResJnlLine);
    end;
...
#pragma warning restore AS0072
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateSalesLineBeforePostOnAfterPostContratoContractLine(SalesInvoiceHeader: Record "Sales Invoice Header"; SalesCrMemoHeader: Record "Sales Cr.Memo Header"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostContratoContractLineBeforeTestFields(var SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var IsHandled: Boolean)
    begin
    end;
