codeunit 50201 "Contrato Calculate Batches"
{
    ...
    var
        JobDiffBuffer: array[2] of Record "Contrato Difference Buffer" temporary;
    ...
    local procedure SplitOneLine(JobPlanningLine: Record "Contrato Planning Line"): Boolean
    var
    ...
    procedure TransferToPlanningLine(var JobLedgEntry: Record "Contrato Ledger Entry"; LineType: Integer)
    var
    ...
    local procedure InsertDiffBuffer(var JobLedgEntry: Record "Contrato Ledger Entry"; var JobPlanningLine: Record "Contrato Planning Line"; LineType: Option Schedule,Usage; CurrencyType: Option LCY,FCY)
    begin
    ...
    local procedure OnBeforeJobPlanningLineInsert(var JobPlanningLine: Record "Contrato Planning Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforePostDiffBuffer(var JobDiffBuffer: array[2] of Record "Contrato Difference Buffer" temporary; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeTransferToPlanningLine(var JobLedgerEntry: Record "Contrato Ledger Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCreateJTOnBeforeAssigneJobDiffBuffer2(var JobDiffBuffer: array[2] of Record "Contrato Difference Buffer" temporary; JobPlanningLine: Record "Contrato Planning Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnChangeCurrencyDatesOnBeforeJobPlanningLineModify(var JobPlanningLine: Record "Contrato Planning Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnChangePlanningDatesOnBeforeJobPlanningLineModify(var JobPlanningLine: Record "Contrato Planning Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostDiffBufferOnAfterInsertJobJnlLine(var JobJnlLine: Record "Contrato Journal Line"; var JobDiffBuffer: Record "Contrato Difference Buffer" temporary)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostDiffBufferOnBeforeModify(var JobLedgEntry: Record "Contrato Ledger Entry"; var JobDiffBuffer: Record "Contrato Difference Buffer" temporary)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostDiffBufferOnAfterSetFilters(var JobLedgerEntry: Record "Contrato Ledger Entry"; var JobDifferenceBuffer: Record "Contrato Difference Buffer" temporary)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCreateJT(var IsHanlded: Boolean; JobPlanningLine: Record "Contrato Planning Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertDiffBuffer(var JobLedgerEntry: Record "Contrato Ledger Entry"; var JobPlanningLine: Record "Contrato Planning Line"; var JobDiffBuffer: array[2] of Record "Contrato Difference Buffer" temporary; LineType: Option Schedule,Usage; CurrencyType: Option LCY,FCY)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertDiffBuffer(var JobLedgerEntry: Record "Contrato Ledger Entry"; var JobPlanningLine: Record "Contrato Planning Line"; var JobDiffBuffer: array[2] of Record "Contrato Difference Buffer" temporary; LineType: Option Schedule,Usage; CurrencyType: Option LCY,FCY)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnChangeCurrencyDatesOnBeforeChangeCurrencyDate(var JobPlanningLine: Record "Contrato Planning Line"; var ForceDateUpdate: Boolean)
    begin
    end;
}
