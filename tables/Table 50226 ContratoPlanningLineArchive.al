table 50226 "Contrato Planning Line Archive"
{
    Caption = 'Contrato Planning Line';
    DrillDownPageID = "ContratoPlanningArchiveLines";
    LookupPageID = "ContratoPlanningArchiveLines";
    ...
    fields
    {
        ...
        field(1000; "Contrato Task No."; Code[20])
        {
            ...
            NotBlank = true;
            TableRelation = "Contrato Task Archive"."Contrato Task No." where("Contrato No." = field("Contrato No."));
        }
    ...
    keys
    {
        key(Key1; "Contrato No.", "Contrato Task No.", "Version No.", "Line No.")
        {
            Clustered = true;
        }
    }
