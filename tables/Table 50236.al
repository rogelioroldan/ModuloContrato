...
table 50236 "Contrato Queue Category"
{
    Caption = 'Contrato Queue Category';
    DataCaptionFields = "Code", Description;
    DrillDownPageID = "Contrato Queue Category List";
    LookupPageID = "Contrato Queue Category List";
    Permissions = TableData "Contrato Queue Category" = rimd;
