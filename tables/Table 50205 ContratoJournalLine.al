table 50205 "Contrato Journal Line"
{
    ...
    fields
    {
        ...
        field(73; "Journal Batch Name"; Code[10])
        {
            ...
            TableRelation = "Contrato Journal Batch".Name where("Journal Template Name" = field("Journal Template Name"));
        }
...
#pragma warning restore
    ...
    begin
        ReservationEntry.SetSource(DATABASE::"Contrato Journal Line", "Entry Type".AsInteger(), "Journal Template Name", "Line No.", "Journal Batch Name", 0);
    ...
    begin
        ReservationEntry.SetSourceFilter(DATABASE::"Contrato Journal Line", "Entry Type".AsInteger(), "Journal Template Name", "Line No.", false);
    ...
    begin
        exit(
          ItemTrackingMgt.ComposeRowID(DATABASE::"Contrato Journal Line", "Entry Type".AsInteger(),
