table 50224 "Contrato Archive"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = exist("Comment Line Archive" where("Table Name" = const(Contrato),
                                                            "No." = field("No."),
        ...
        {
            CalcFormula = sum("Contrato Planning Line Archive"."Quantity (Base)" where("Contrato No." = field("No."),
        ...
        {
            CalcFormula = min("Contrato Planning Line Archive"."Planning Date" where("Contrato No." = field("No."),
                                                                         "Version No." = field("Version No."),
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("Contrato Task Archive"."Recognized Sales Amount" where("Contrato No." = field("No."),
                                                                        "Version No." = field("Version No.")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("Contrato Task Archive"."Recognized Costs Amount" where("Contrato No." = field("No."),
                                                                                "Version No." = field("Version No.")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("Contrato Task Archive"."Recognized Sales G/L Amount" where("Contrato No." = field("No."),
                                                                                    "Version No." = field("Version No.")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("Contrato Task Archive"."Recognized Costs G/L Amount" where("Contrato No." = field("No."),
                                                                                    "Version No." = field("Version No.")));
        ...
        {
            FieldClass = Flowfield;
            CalcFormula = exist(Contrato where("No." = field("No.")));
        ...
        field(3999; "Last Archived Date"; DateTime)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = max("Contrato Archive".SystemCreatedAt where("No." = field("No.")));
            Editable = false;
        }
        ...
        {
            CalcFormula = min("Contrato Planning Line Archive"."Completely Picked" where("Contrato No." = field("No.")));
