table 50218 "Assemble-to-OrderLinkContrato"
{
    Caption = 'Assemble-to-Order Link';
    DataClassification = CustomerContent;
    Permissions = TableData "Assembly Header" = rimd,
                  TableData "Assemble-to-OrderLinkContrato" = rimd;
...
#pragma warning restore AS0004
    ...
    procedure CheckIfAssembleToOrderLinkExist(Contrato: Record Contrato)
    begin
    ...
    begin
        if Contrato.Status = Contrato.Status::Open then begin
            ...
            if Contrato.Status in [Contrato.Status::Quote, Contrato.Status::Planning] then begin
    ...
    local procedure OnAfterUpdateAsm(var AsmHeader: Record "Assembly Header"; var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var SalesLine: Record "Sales Line"; AsmExists: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetATOLink(var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var AssemblyHeader: Record "Assembly Header"; var LinkFound: Boolean; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeReserveAsmToSale(var SalesLine: Record "Sales Line"; QtyToReserve: Decimal; QtyToReserveBase: Decimal; var IsHandled: Boolean; var AssembletoOrderLink: Record "Assemble-to-OrderLinkContrato")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnMakeAsmOrderLinkedToSalesOrderLineOnBeforeCheckDocumentType(var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var ToAssemblyHeader: Record "Assembly Header"; FromAssemblyHeader: Record "Assembly Header"; ToSalesLine: Record "Sales Line"; FromSalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateAsmOnBeforeSynchronizeAsmFromSalesLine(var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var AssemblyHeader: Record "Assembly Header"; SalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateAsmOnBeforeAsmReOpenIfReleased(var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var AssemblyHeader: Record "Assembly Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterReserveAsmToSale(var AssembletoOrderLink: Record "Assemble-to-OrderLinkContrato"; var AsmHeader: Record "Assembly Header"; var SalesLine: Record "Sales Line"; var TrackingSpecification: Record "Tracking Specification"; QtyToReserve: Decimal; QtyToReserveBase: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeRollUpPrice(var SalesLine: Record "Sales Line"; var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeAsmExistsForWhseShptLine(var AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; WarehouseShipmentLine: Record "Warehouse Shipment Line"; var AsmExists: Boolean; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetAsmHeader(AssembleToOrderLink: Record "Assemble-to-OrderLinkContrato"; var AssemblyHeader: Record "Assembly Header"; var HeaderFound: Boolean; var IsHandled: Boolean)
    begin
    end;
}
